...
点下表直达下载 **v0.4.5**，或前往 [**Releases**](https://github.com/xiaocoss/quotio-desktop/releases/latest) 取最新版：

| 平台 | 下载 |
|---|---|
| **Windows** | [`.msi`（推荐）](https://github.com/xiaocoss/quotio-desktop/releases/download/v0.4.5/Quotio_0.4.5_x64_en-US.msi) · [`-setup.exe`](https://github.com/xiaocoss/quotio-desktop/releases/download/v0.4.5/Quotio_0.4.5_x64-setup.exe) |
| **macOS**（Apple Silicon & Intel 通用） | [`.dmg`](https://github.com/xiaocoss/quotio-desktop/releases/download/v0.4.5/Quotio_0.4.5_universal.dmg) |
| **Linux** | [`.deb`](https://github.com/xiaocoss/quotio-desktop/releases/download/v0.4.5/Quotio_0.4.5_amd64.deb) · [`.rpm`](https://github.com/xiaocoss/quotio-desktop/releases/download/v0.4.5/Quotio-0.4.5-1.x86_64.rpm) · [`.AppImage`](https://github.com/xiaocoss/quotio-desktop/releases/download/v0.4.5/Quotio_0.4.5_amd64.AppImage) |

> 上表为 v0.4.5 直链；后续新版请走 [Releases](https://github.com/xiaocoss/quotio-desktop/releases/latest) 页。
